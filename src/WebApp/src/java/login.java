    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (trial > 5) {
                ...
                int access = 2;
                if (request.getParameter("email").equals("admin@msu.com")&&request.getParameter("pwd").equals("admin")){
                    access = 1;
                    session.setAttribute("access", access);
                    out.print("1");
                }else if (request.getParameter("email").equals("student@msu.com")&&request.getParameter("pwd").equals("student")){
                    access = 0;
                    session.setAttribute("access", access);
                    out.print("1");
                }else{
