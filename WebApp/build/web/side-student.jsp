    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            <ul class="sidebar navbar-nav">
                <li class="nav-item"> <a class="nav-link" href="javascript:setContent('/Admission/homepage');"> <i class="fas fa-home"></i> <span>Homepage</span></a> </li>
                <li class="nav-item"> <a class="nav-link" href="javascript:setContent('/Admission/viewTimetable');"> <i class="fas fa-calendar-alt"></i> <span>Timetable</span></a> </li>
                <div style="height:100%" onclick="javascript:document.getElementById('sidebarToggle').click();">

                </div></ul> <script>document.getElementById('pic').innerHTML = "<img style='width:30px;height:30px;' src='images/student.png' style='border-radius:50%;'/>";</script> 
